...
/* Stats panels (Recent games / Top scoring / Leaderboard / Most-played)
 * moved to /tv.php's right column — see knk_darts_tv_stats() in
 * includes/darts_stats.php. The phone tab no longer renders them. */
...
<?php endif; ?>
    ...
    <?php elseif ($view === 'pick_board'): ?>
      ...
      <!-- Recent games / Top scoring / Leaderboard / Most-played panels
           used to live here. They moved to /tv.php's right column under
           "Waiting for players" so the social-proof lives on the bar
